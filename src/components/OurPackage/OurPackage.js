...
function OurPackage() {
    ...
    function openTripClick(){
        navigate('/open-trip-detail')
    }
    function privateTripClick(){
        navigate('/private-trip-detail')
    }
  return (
    <>
